...
export interface IndexPageQuery_halloffame_edges_node_frontmatter_image_childImageSharp_fluid {
  base64: string | null;
  aspectRatio: number;
  src: string;
  srcSet: string;
...
export interface IndexPageQuery_halloffame_edges_node_frontmatter_image_childImageSharp {
  fluid: IndexPageQuery_halloffame_edges_node_frontmatter_image_childImageSharp_fluid | null;
}

export interface IndexPageQuery_halloffame_edges_node_frontmatter_image {
  childImageSharp: IndexPageQuery_halloffame_edges_node_frontmatter_image_childImageSharp | null;
}

export interface IndexPageQuery_halloffame_edges_node_frontmatter {
  title: string;
  description: string | null;
  date: any | null;
  image: IndexPageQuery_halloffame_edges_node_frontmatter_image | null;
}

export interface IndexPageQuery_halloffame_edges_node_fields {
  slug: string | null;
}

export interface IndexPageQuery_halloffame_edges_node {
  id: string;
  frontmatter: IndexPageQuery_halloffame_edges_node_frontmatter | null;
  fields: IndexPageQuery_halloffame_edges_node_fields | null;
}

export interface IndexPageQuery_halloffame_edges {
  node: IndexPageQuery_halloffame_edges_node;
}

export interface IndexPageQuery_halloffame {
  edges: IndexPageQuery_halloffame_edges[];
}

export interface IndexPageQuery {
  site: IndexPageQuery_site | null;
  portfolio: IndexPageQuery_portfolio;
  halloffame: IndexPageQuery_halloffame;
}
